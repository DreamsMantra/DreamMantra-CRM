...
export default function LeadForm({ form, onChange, onSubmit, loading, submitLabel = 'Submit Lead', templateFields }) {
    ...
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      {show('whatsappOptIn') && (
        <label className="flex items-center gap-2 text-sm text-stone-600">
          <input type="checkbox" checked={form.whatsappOptIn} onChange={(e) => update('whatsappOptIn', e.target.checked)} className="rounded border-stone-300 text-orange" />
