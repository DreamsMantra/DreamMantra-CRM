...
export const api = {
  ...
  partner: {
    ...
    deleteProject: (id) => request(`/partner/projects/${id}`, { method: 'DELETE' }),
    assignLeadsToProject: (id, leadIds) => request(`/partner/projects/${id}/assign-leads`, { method: 'POST', body: JSON.stringify({ leadIds }) }),
  },
  ...
  admin: {
    ...
    createCustomRole: (body) => request('/admin/roles/custom', { method: 'POST', body: JSON.stringify(body) }),
    deleteCustomRole: (id) => request(`/admin/roles/custom/${id}`, { method: 'DELETE' }),
    products: () => request('/admin/products'),
    updateProducts: (products) => request('/admin/products', { method: 'PUT', body: JSON.stringify({ products }) }),
    productAllocations: () => request('/admin/product-allocations'),
    updateProductAllocations: (allocations) => request('/admin/product-allocations', { method: 'PUT', body: JSON.stringify({ allocations }) }),
    ...
    partnerActivities: (id) => request(`/admin/partners/${id}/activities`),
    createPartnerActivity: (id, body) => request(`/admin/partners/${id}/activities`, { method: 'POST', body: JSON.stringify(body) }),
    updatePartnerActivity: (id, body) => request(`/admin/partner-activities/${id}`, { method: 'PATCH', body: JSON.stringify(body) }),
    deletePartnerActivity: (id) => request(`/admin/partner-activities/${id}`, { method: 'DELETE' }),
    partnerProjects: (id) => request(`/admin/partners/${id}/projects`),
    createPartnerProject: (id, body) => request(`/admin/partners/${id}/projects`, { method: 'POST', body: JSON.stringify(body) }),
    updateAgencyProject: (id, body) => request(`/admin/agency-projects/${id}`, { method: 'PATCH', body: JSON.stringify(body) }),
    deleteAgencyProject: (id) => request(`/admin/agency-projects/${id}`, { method: 'DELETE' }),
    assignLeadsToProject: (id, leadIds) => request(`/admin/agency-projects/${id}/assign-leads`, { method: 'POST', body: JSON.stringify({ leadIds }) }),
