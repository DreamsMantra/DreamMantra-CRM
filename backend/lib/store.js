...
export const defaultStore = {
  ...
  settings: {
    ...
    customForms: [],
    products: [
      { id: 'brain_mapping', label: 'Brain Mapping', price: 4999, defaultSellingPrice: 5499, commission: { type: 'fixed', value: 200 } },
      { id: 'skill_mapping', label: 'Skill Mapping', price: 3999, defaultSellingPrice: 4499, commission: { type: 'fixed', value: 100 } },
      { id: 'ai_career_launchpad', label: 'AI Career Launchpad', price: 9999, defaultSellingPrice: 10999, commission: { type: 'percentage', value: 10 } },
      { id: 'counselling', label: 'Counselling', price: 1999, defaultSellingPrice: 2499, commission: { type: 'percentage', value: 15 } },
    ],
    commissionRules: [],
    rolePermissions: {},
    customRoles: [],
